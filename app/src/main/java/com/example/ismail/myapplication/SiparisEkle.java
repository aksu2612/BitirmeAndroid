...
public class SiparisEkle extends Activity {
    ...
    String DataParseUrl = "http://www.ganahijyen.com/SU/php/siparisekle.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextWebsite = (EditText)findViewById(R.id.editText4);
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newAct = new Intent(getApplicationContext(), Siparis.class);
    ...
    public void SendDataToServer(final String name, final String email, final String website){
        class SendPostReqAsyncTask extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result) {
                ...
                Toast.makeText(SiparisEkle.this, "Siparişiniz Alındı.", Toast.LENGTH_LONG).show();
            }
        }
